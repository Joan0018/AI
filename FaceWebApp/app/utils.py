...
def faceRecognitionVideo(path):
    ...
    #save the encodings and the corresponding labels in seperate arrays in the same order
    known_face_encodings = [lim_face_encodings, joan_face_encodings, aaron_Peirsol_face_encodings, aaron_Sorkin_face_encodings, abdel_Nasser_Assidi_face_encodings, 
                            ...
                            adolfo_Aguilar_Zinser_face_encodings, ahmed_Chalabi_face_encodings, ai_Sugiyama_face_encodings,
                            aicha_El_Ouafi_face_encodings, akbar_Hashemi_Rafsanjani_face_encodings, akhmed_Zakayev_face_encodings,
                            al_Gore_face_encodings, alan_Ball_face_encodings, alberto_Fujimori_face_encodings,
                            alberto_Ruiz_Gallardon_face_encodings, albrecht_Mentz_face_encodings, alec_Baldwin_face_encodings,
                            modi_face_encodings]
